...
const AUTH_SSO_AUTH_URL = process.env.SGREP_SSO_AUTH_URL;
const AUTH_SSO_TOKEN_URL = process.env.SGREP_SSO_TOKEN_URL;
const AUTH_SSO_CLIENT_ID = process.env.SGREP_SSO_CLIENT_ID;
const AUTH_SSO_SECRET = process.env.SGREP_SSO_SECRET;
const AUTH_SSO_CB_URL = process.env.SGREP_SSO_CB_URL;
const _READY = (
   AUTH_SSO_AUTH_URL &&
   AUTH_SSO_TOKEN_URL &&
   AUTH_SSO_CLIENT_ID &&
